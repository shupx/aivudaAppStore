...
def _find_manifest_member(names: Set[str]) -> Optional[str]:
...
def _detect_package_prefix(names: Set[str], manifest_member: Optional[str]) -> str:
    if manifest_member:
...
async def modify_version(
    *,
    ...
    package_zip: Optional[UploadFile] = None,
) -> Dict[str, Any]:
